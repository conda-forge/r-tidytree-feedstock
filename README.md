...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1734&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-tidytree-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-tidytree` can be installed with `conda`:
...
```
mamba install r-tidytree
```

It is possible to list all of the versions of `r-tidytree` available on your platform with `conda`:
...
```
mamba search r-tidytree --channel conda-forge
```
...
mamba repoquery search r-tidytree --channel conda-forge

# List packages depending on `r-tidytree`:
mamba repoquery whoneeds r-tidytree --channel conda-forge

# List dependencies of `r-tidytree`:
mamba repoquery depends r-tidytree --channel conda-forge
```
